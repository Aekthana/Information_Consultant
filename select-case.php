<?php 
    ...
    WHERE consultant.id_student = student.id_student AND consultant.id_room = room.id_room AND room.id_room = '$idRoom'
    ORDER BY consultant.given_date ASC";
    $result = mysqli_query($connect,$sql);
    $count = mysqli_num_rows($result);

    $nameRommresult = mysqli_query($connect,$sql);
...
<body>
    ...
    <section class="mb-5">
        <h1 class='text-center'>นักศึกษาที่มีปัญหาห้อง <?php echo $nameRoom['abbreviation'] ;?></h1>
